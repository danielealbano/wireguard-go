...
// endpoints report their ws_mode/wstunnel_target/ws_bearer; a server inbound endpoint (no URL)
...
func TestWSEndpoint_WSConfig(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			e:      WSEndpoint{dialect: wsDialectStandard, wstunnelTarget: "ignored", bearer: "ignored"},
			wantOK: false,
		},
		{
		...
		},
		{
			...
			e:          WSEndpoint{url: "wss://relay.example.com:8443", dialect: wsDialectWstunnel, wstunnelTarget: "10.0.0.9:51820", bearer: "tok"},
			wantMode:   "wstunnel",
